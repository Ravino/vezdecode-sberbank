        ...
        <div class="mainstyle" style="flex: 1; -webkit-flex: 1;">
          <div class="mainstyle csdcs">
            <div class="mainstyle gdfdc">
              <div class="mainstyle gfvcds">
                ...
                <div class="gvcxd" dir="auto">
                  <span>Узнайте, какие тебе доступны сейчас вакансии для отклика на краткосрочные вакансии, появившиеся из-за отпуска или больничного.</span>
                </div>
                <div class="r-jwli3a" dir="auto">
                  <span>Присоединяйтесь к Cбер подработке прямо сейчас!</span>
                </div>
                <div>
            ...
            <div class="mainstyle gfdsdf">
                <div style="font-family: Righteous, sans-serif;font-size: 500%;">NESA</div>
            </div>
          </div>
        </div>
      </main>
...
.btn_signup {
  margin-bottom: 15px;
  background-color: rgb(66, 227, 180);
  color: white;
  cursor: pointer;
...
.btn_signup:hover {
  background-color: rgb(33, 186, 114);
}
